            ...
            <View style={styles.mainView}>
                <ScrollView showsVerticalScrollIndicator={false} >
                    ...
                    <Header name='Sign In' nav='signin' />
                        <Text style={{ fontSize: RFValue(23), fontWeight: "bold", marginTop: 20 }}>
                            Account Information</Text>
                        <View >

                        <Picker
                            selectedValue={form.title}
                            onValueChange={(itemValue) => {setForm({...form, title: itemValue}); setValue('p_title', itemValue)}}>
                        ...
                        <Picker
                            ...
                            onValueChange={(itemValue) => {setForm({...form, state: itemValue}); setValue('p_state_id', itemValue)}}
                        >
                        ...
                        <Picker
                            ...
                            selectedValue={(itemValue) => itemValue}
                        ...
                        <TextInput style={styles.textInput}
                            // value={form.phone}
                            onChangeText={(text) => { setValue('p_phone_no', text)}}
                        ...
                        <TextInput style={styles.textInput}
                            // value={form.email}
                            onChangeText={(text) => { setValue('p_email', text)}}
                    ...
                    />
                        ...
                        <View
                        style={{ width: "100%", borderBottomWidth: RFValue(2), borderBottomColor: "black", marginBottom: RFValue(10) }}>
                        </View>
