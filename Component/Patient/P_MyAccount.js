    ...
    return (
        <ScrollView>
                ...
                <View style={styles.upperheader} >
                    <View style={styles.myaccount}>
                        ...
                        <View style={styles.memberDetail}>
                            <Text style={{ fontSize: 20 }} >Member's Name</Text>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.btnGroup}>
                    <TouchableOpacity style={styles.buttonStyle} activeOpacity={.5}
                        onPress={() => { navigation.navigate("P_ChangePassword") }}>
                ...
                <View style={styles.btnGroup}>
                    <TouchableOpacity style={styles.buttonStyle} activeOpacity={.5}
                        onPress={() => { navigation.navigate("P_ChangePin") }}>
                ...
                <View style={styles.btnGroup}>
                    <TouchableOpacity style={styles.buttonStyle} activeOpacity={.5}
                        onPress={() => { navigation.navigate("P_Deactivate") }}>
                ...
                <View style={styles.btnGroup}>
                    <TouchableOpacity style={styles.buttonStyle} activeOpacity={.5}
                        onPress={() => { navigation.navigate("P_SharePage") }}>
