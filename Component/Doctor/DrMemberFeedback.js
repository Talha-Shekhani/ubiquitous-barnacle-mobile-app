...
export default function DrAppoinmentLog(){
    ...
    const file = [
    {
        id: 1,
        name: "Member Name",
        text: "Loverm jkJFk fJKLjfkl kdjSF KLdfjfkjkfjkfljfklfdjfkjk fkl jlkafj flfajlfjlfjalkfj klfjklfj kfkljfhfjhfjhjf hjfhjf hfj hjhfdjk hfjklfh jfkhfjkhfjl fjfhjfhfjf llfjhf jfhljfkhfjhljdhljlfk hlf fjkhf fjh fj kljklfj lfkl klj klfj lkgfj lskajklgklgjgkl lkga jklg gkl",
        ...
        return(
            <View>
                <View>
                    ...
                    <Text  numberOfLines={4} ellipsizeMode='tail' style={ styles.memberText }> {item.text}   </Text>
