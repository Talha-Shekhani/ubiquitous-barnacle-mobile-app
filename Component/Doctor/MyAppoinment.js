        ...
        <View style={styles.mainView}>
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <TouchableOpacity style={styles.buttonStylelarge} activeOpacity={.5}
                    ...
                    <Text style={styles.TextStyle2}> Upcoming Appoinments </Text>
                    <IconFont name='angle-right' size={40} />
                </TouchableOpacity>
                <TouchableOpacity style={styles.buttonStylelarge} activeOpacity={.5}
                    onPress={() => { navigation.navigate("drPreviousAppoinment") }}>
                    <Text style={styles.TextStyle2}> Previous Appoinments </Text>
                    <IconFont name='angle-right' size={40} />
                </TouchableOpacity>
                </View>
            </ScrollView>
