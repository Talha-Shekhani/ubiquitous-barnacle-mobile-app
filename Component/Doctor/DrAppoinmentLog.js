        ...
        return(
            <View>
                <View>
                    ...
                    <Text style={ styles.memberText }> Date: {item.Date}   </Text>
                    <Text style={ styles.memberText }> Time: {item.Time}  </Text>
                    <Text style={ styles.memberText }> Duration of cell : {item.Duration} </Text>
                </View>
