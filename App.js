...
import ConnectSearch from './Component/Navigation/ConnectSearch'
import SearchBySpeciality from './Component/Navigation/SearchBySpeciality'
import SearchByHealth from './Component/Navigation/SearchByHealth'
import ViewProfile from './Component/Navigation/ViewProfile'
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <NavigationContainer > 
            ...
            <Stack.Screen name="ConnectSearch" component={ConnectSearch}/>
            <Stack.Screen name="SearchBySpeciality" component={SearchBySpeciality}/>
            <Stack.Screen name="SearchByHealth" component={SearchByHealth}/>
